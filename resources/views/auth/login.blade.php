                ...
                <div class="card-body mt-4">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="mt-4 ml-4 mr-4 mb-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="entrez votre mot de passe" required autocomplete="current-password">
