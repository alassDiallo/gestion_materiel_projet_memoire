...
{
    use HasFactory;
    protected $fillable = ["idMedecin","referenceMedecin","nom","prenom","dateDeNaissance","lieuDeNaissance","sexe","adresse","telephone","email","description","idSpecialite",'experience'];
